module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    shell: {
      ...
      standalone: {
        command: 'component build --standalone ListRegSearch -n list.regsearch.standalone'
      },
      mkdir: {
        command: 'mkdir -p dist'
      },
      move: {
        command: 'mv build/list.regsearch.standalone.js dist/list.regsearch.js'
      },
      remove: {
    ...
    uglify: {
      target: {
        files: {
          'dist/list.regsearch.min.js': ['dist/list.regsearch.js']
        }
      }
    },
    mocha: {
